...
CSS = """
<style>
:root{--bg:#f8f9ff;--card:#fff;--ink:#0b1c30;--muted:#64748b;--line:#d8deeb;--p:#4f46e5;--pd:#3525cd;--ps:#eef0ff;--t:#14b8a6;--ts:#dcfbf6;--w:#f59e0b;--ws:#fff7ed;--d:#dc2626;--ds:#fff1f2}
html,body,.stApp,[data-testid="stAppViewContainer"],[data-testid="stAppViewBlockContainer"]{background:var(--bg)!important;color:var(--ink)!important;color-scheme:light!important;font-family:"Microsoft YaHei UI","Microsoft YaHei","微软雅黑","PingFang SC",sans-serif!important}header,#MainMenu,footer{visibility:hidden;height:0}.block-container{max-width:1480px;padding:0 28px 82px!important}.topbar{height:72px;margin:0 -28px 34px;padding:0 28px;border-bottom:1px solid var(--line);background:#fbfcff;display:flex;align-items:center;justify-content:space-between}.brand{display:flex;gap:12px;align-items:center}.mark{width:34px;height:34px;border-radius:10px;background:#edf0ff;color:var(--pd);display:grid;place-items:center;font-weight:900}.brand-name{font-size:20px;font-weight:850;color:var(--pd)}.sub{font-size:12px;color:var(--muted)}.actions{display:flex;gap:16px;align-items:center}.nav-i,.avatar{width:34px;height:34px;border-radius:10px;display:grid;place-items:center}.avatar{border-radius:999px;background:#dff4ff;border:1px solid #cfd8ea;font-weight:800;color:#31516d}div[role="radiogroup"]{display:flex;justify-content:center;gap:30px;margin-top:-91px;margin-bottom:54px;position:relative;z-index:5}div[role="radiogroup"] label{background:transparent!important;border:0!important;border-radius:0!important;padding:24px 2px 17px!important;font-weight:800;color:#111827!important}div[role="radiogroup"] label>div:first-child{display:none!important}div[role="radiogroup"] input{position:absolute!important;opacity:0!important;width:0!important;height:0!important}div[role="radiogroup"] label:has(input:checked){color:var(--pd)!important;border-bottom:3px solid var(--p)!important}.title{margin:0 0 26px}.title h1{margin:0 0 8px;font-size:32px;line-height:1.22;font-weight:850}.title p{margin:0;color:#4b5563;font-size:16px;line-height:1.65}.card,.sec{background:var(--card);border:1px solid var(--line);border-radius:16px;box-shadow:0 4px 12px rgba(15,23,42,.04)}.pad{padding:24px}.sec{padding:22px 24px;margin-bottom:20px}.head{display:flex;align-items:center;gap:10px;margin-bottom:18px}.head .ic{width:28px;height:28px;border-radius:8px;background:var(--ps);color:var(--pd);display:grid;place-items:center;font-weight:900}.head h3{margin:0;font-size:20px}.note{font-size:12px;color:var(--muted);line-height:1.55}.grid4{display:grid;grid-template-columns:repeat(4,1fr);gap:18px}.metric{background:#fff;border:1px solid var(--line);border-radius:16px;padding:20px}.ml{color:var(--muted);font-size:13px;font-weight:720}.mv{font-size:30px;font-weight:900;line-height:1.25;margin-top:8px;color:var(--pd)}.teal{color:#087d72!important}.warn{color:#d97706!important}.chip{display:inline-flex;border-radius:999px;padding:4px 10px;font-size:12px;font-weight:850;border:1px solid var(--line);background:#f8fafc;color:#475569;white-space:nowrap}.cp{background:var(--ps);border-color:#d7d7ff;color:var(--pd)}.ct{background:var(--ts);border-color:#a9eee4;color:#04786e}.cw{background:var(--ws);border-color:#fed7aa;color:#b45309}.cd{background:var(--ds);border-color:#fecdd3;color:#b91c1c}.cm{background:#f1f5f9;color:#64748b}.sg{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.tile{background:#eef3ff;border:1px solid #dbe4fb;border-radius:10px;padding:15px}.tile .k{font-size:12px;color:#475569;font-weight:750}.tile .v{font-family:"Microsoft YaHei UI","Microsoft YaHei","微软雅黑",sans-serif;font-size:26px;font-weight:900;color:var(--pd);margin-top:6px}.notice,.warning,.danger{border-radius:12px;padding:12px 14px;font-size:13px;line-height:1.65}.notice{border:1px solid #bfe8f3;background:#effbff;color:#164e63}.warning{border:1px solid #fed7aa;background:#fff7ed;color:#9a3412}.danger{border:1px solid #fecdd3;background:#fff1f2;color:#991b1b}.visits{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:18px}.visit{border:1px solid var(--line);border-radius:14px;background:#fff;padding:16px}.visit.latest{background:#f0f7ff;border-color:#bcd7ff}.vt{display:flex;justify-content:space-between;margin-bottom:10px;font-weight:850}.vb{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.vk{font-size:12px;color:var(--muted)}.vv{font-family:"Microsoft YaHei UI","Microsoft YaHei","微软雅黑",sans-serif;font-weight:850}.mw{overflow-x:auto;border:1px solid var(--line);border-radius:8px;background:#fff}.matrix{min-width:980px;border-collapse:separate;border-spacing:0;width:100%;font-family:"Microsoft YaHei UI","Microsoft YaHei","微软雅黑",sans-serif}.matrix th,.matrix td{border-right:1px solid var(--line);border-bottom:0;padding:17px 20px;text-align:center}.matrix th{background:#eef3ff;color:#334155;font-size:13px;font-weight:850}.matrix td{font-family:"Microsoft YaHei UI","Microsoft YaHei","微软雅黑",sans-serif;font-weight:800}.matrix th:first-child,.matrix td:first-child{position:sticky;left:0;text-align:left;background:#eef3ff;font-family:inherit;z-index:1;min-width:170px}.matrix th:last-child,.matrix td:last-child{border-right:0}.row-label{font-weight:900}.row-fsh{color:#d94663}.row-lh{color:#f59e0b}.row-hmg{color:#2563eb}.row-e2{color:#0f766e}.row-lhv{color:#7c3aed}.row-p{color:#475569}.row-oocyte{color:#4f46e5}.row-mii{color:#4f46e5}.row-ohss{color:#14b8a6}.today{background:#fff}.pred{background:#f0f5ff;color:#243b75}.pred-note{display:block;margin-top:3px;font-size:11px;color:#64748b;font-weight:700}.future{background:#f6f7fb;color:#94a3b8}.tbl{width:100%;border-collapse:collapse;background:#fff;border:1px solid var(--line);border-radius:16px;overflow:hidden}.tbl th{background:#eef3ff;color:#475569;text-align:left;font-size:12px;padding:13px 12px;border-bottom:1px solid var(--line)}.tbl td{padding:14px 12px;border-bottom:1px solid #edf1f7;font-size:13px}.mono{font-family:"Microsoft YaHei UI","Microsoft YaHei","微软雅黑",sans-serif}.rank{width:28px;height:28px;border-radius:999px;background:var(--p);color:#fff;display:grid;place-items:center;font-weight:900}.alink{display:inline-flex;border:1px solid #d7d7ff;border-radius:8px;color:var(--pd);padding:7px 10px;font-weight:850;background:#fff}.status{position:fixed;left:0;right:0;bottom:0;height:38px;background:#eef3ff;border-top:1px solid var(--line);z-index:20;display:flex;align-items:center;justify-content:space-between;padding:0 28px;color:#334155;font-size:12px;font-weight:750}.links{display:flex;gap:24px}.quick{display:grid;grid-template-columns:1.45fr 1fr;gap:20px}.plist{width:100%;border-collapse:collapse}.plist th{font-size:12px;color:#64748b;background:#eef3ff;text-align:left;padding:11px}.plist td{padding:13px 11px;border-bottom:1px solid #edf1f7;font-size:13px}.qcard{border:1px solid var(--line);border-radius:14px;background:#fff;padding:18px;display:flex;justify-content:space-between;gap:14px;align-items:center;margin-bottom:12px}.curves,.cases,.shap-top,.shap-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:18px}.curve-sensitivity{border:1px solid #e2e8f0;border-radius:12px;background:#fbfdff;margin:10px 0 12px;overflow:hidden}.curve-s-head,.curve-s-row{display:grid;grid-template-columns:86px repeat(3,minmax(0,1fr));gap:8px;align-items:center}.curve-s-head{background:#eef3ff;color:#475569;font-size:11px;font-weight:900;padding:8px 10px}.curve-s-row{padding:9px 10px;border-top:1px solid #edf1f7}.curve-s-label{font-size:12px;font-weight:900;color:#0b1c30}.curve-s-cell{min-width:0}.curve-s-val{font-size:13px;font-weight:950;color:#0b1c30}.curve-s-dose{display:block;font-size:10px;color:#64748b;font-weight:800;margin-bottom:2px}.curve-s-delta{display:inline-flex;margin-top:3px;border-radius:999px;padding:2px 7px;font-size:11px;font-weight:900;border:1px solid #dbe4fb;background:#fff;color:#64748b}.curve-s-delta.up{border-color:#a9eee4;background:#dcfbf6;color:#04786e}.curve-s-delta.down{border-color:#fecdd3;background:#fff1f2;color:#b91c1c}.curve-s-delta.warn{border-color:#fed7aa;background:#fff7ed;color:#b45309}.curve-s-delta.flat{border-color:#e2e8f0;background:#f8fafc;color:#64748b}.tech-sens{margin-top:18px}.tech-dose-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin-top:14px}.tech-dose-card{border:1px solid #dbe4fb;border-radius:14px;background:#fff;padding:14px;min-width:0}.tech-dose-head{display:flex;justify-content:space-between;align-items:flex-start;gap:10px;margin-bottom:12px}.tech-dose-title{font-size:15px;font-weight:950;color:#0b1c30}.tech-dose-sub{font-size:11px;color:#64748b;margin-top:3px;line-height:1.35}.tech-dose-row{border-top:1px solid #edf1f7;padding:11px 0}.tech-dose-row:first-of-type{border-top:0}.tech-dose-row-title{font-size:12px;font-weight:900;color:#334155;margin-bottom:8px}.tech-dose-metrics{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.tech-dose-metric{min-width:0}.tech-dose-top{display:flex;justify-content:space-between;gap:6px;align-items:center;font-size:11px;color:#64748b;font-weight:850}.tech-dose-top b{font-size:11px;color:#0b1c30;white-space:nowrap}.tech-dose-track{height:8px;border-radius:999px;background:#eef2f7;overflow:hidden;margin:5px 0 4px}.tech-dose-fill{height:100%;border-radius:999px;background:#94a3b8}.tech-dose-fill.up{background:var(--t)}.tech-dose-fill.down{background:#ef5f73}.tech-dose-fill.warn{background:var(--w)}.tech-dose-fill.flat{background:#cbd5e1}.tech-dose-value{font-size:10px;color:#64748b;font-weight:800;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}@media(max-width:1000px){.tech-dose-grid,.tech-dose-metrics{grid-template-columns:1fr}}.svgcard,.case,.shap-card,.dose-card{border:1px solid var(--line);border-radius:16px;background:#fff;padding:18px}.dose-card{display:flex;justify-content:space-between;align-items:center}.dose-card .value{font-size:30px;font-weight:900;color:var(--pd)}.factor{display:grid;grid-template-columns:132px 1fr;gap:14px;align-items:center;margin:14px 0}.bar{height:10px;background:#eef2f7;border-radius:999px;overflow:hidden}.fill{height:100%;border-radius:999px;background:var(--p)}.fill.t{background:var(--t)}.fill.w{background:var(--w)}.fc{grid-column:2;font-size:12px;color:#64748b;margin-top:-8px}.groups{display:grid;grid-template-columns:1fr 1.05fr;gap:26px;align-items:center}.grow{display:grid;grid-template-columns:178px 1fr;gap:14px;align-items:center;margin:14px 0}.gfill{height:100%;background:linear-gradient(90deg,var(--p),var(--t));border-radius:999px}.field-label{font-size:14px;color:#0f1f33;font-weight:850;margin:0 0 7px}.field-label .req{color:#dc2626;font-weight:950}.monitor-record-title{font-size:17px;font-weight:950;color:#0b1c30;margin:2px 0 16px}.monitor-section-title{font-size:16px;font-weight:950;color:#172554;margin:22px 0 12px;padding:8px 0 8px 12px;border-left:4px solid var(--p);background:#f8fbff;border-radius:8px}.mini-hint{margin:8px 0 4px;padding:9px 11px;border-radius:10px;border:1px solid #fed7aa;background:#fff7ed;color:#9a3412;font-size:12px;font-weight:750}.monitor-empty{border:1.5px dashed #b7c3d8;border-radius:14px;background:#fbfdff;padding:18px;color:#64748b;margin-bottom:16px}.stTextInput input,.stNumberInput input,[data-baseweb="input"] input{background:transparent!important;color:var(--ink)!important;-webkit-text-fill-color:var(--ink)!important;font-weight:720!important}.stTextInput>div>div,.stNumberInput>div>div,[data-baseweb="input"]>div,[data-baseweb="select"]>div{background:#fff!important;border:1px solid #94A3B8!important;border-radius:8px!important;min-height:44px!important;box-shadow:none!important}.stTextInput>div>div:focus-within,.stNumberInput>div>div:focus-within,[data-baseweb="input"]>div:focus-within,[data-baseweb="select"]>div:focus-within{border-color:#475569!important;box-shadow:0 0 0 1px #94A3B8!important}.stTextInput label p,.stNumberInput label p,.stSelectbox label p,.stDateInput label p{font-weight:800!important;color:#334155!important}div[data-testid="stButton"]>button,div[data-testid="stFormSubmitButton"] button{border-radius:9px!important;border:1px solid #c7c4d8!important;background:#fff!important;color:var(--pd)!important;min-height:42px!important;font-weight:850!important;box-shadow:none!important}button[kind="primary"],button[data-testid*="primary"],div[data-testid="stButton"]>button[kind="primary"],div[data-testid="stFormSubmitButton"] button[kind="primary"]{background:var(--p)!important;border-color:var(--p)!important;color:#fff!important}@media(max-width:1000px){div[role="radiogroup"]{justify-content:flex-start;overflow-x:auto;margin-top:0;margin-bottom:20px}.topbar{margin-bottom:12px}.grid4,.sg,.curves,.cases,.shap-top,.shap-grid,.quick,.visits,.groups{grid-template-columns:1fr}.block-container{padding-left:16px!important;padding-right:16px!important}.topbar{margin-left:-16px;margin-right:-16px;padding:0 16px}.status{position:static;margin:28px -16px -82px}}
...
.model-strip{border:1px solid #dbe4fb;background:linear-gradient(180deg,#fff,#f8fbff);border-radius:14px;padding:12px 14px;margin:0 0 16px;display:flex;align-items:center;justify-content:space-between;gap:14px;box-shadow:0 4px 10px rgba(15,23,42,.035)}.model-strip-left{display:flex;align-items:center;gap:10px;min-width:0}.model-dot{width:10px;height:10px;border-radius:999px;background:var(--t);box-shadow:0 0 0 4px rgba(20,184,166,.12);display:inline-block;flex:0 0 auto}.model-dot.running{background:var(--p);box-shadow:0 0 0 4px rgba(79,70,229,.12)}.model-dot.warn{background:var(--w);box-shadow:0 0 0 4px rgba(245,158,11,.14)}.model-dot.err{background:var(--d);box-shadow:0 0 0 4px rgba(220,38,38,.12)}.model-strip-title{font-size:13px;font-weight:900;color:#0b1c30}.model-strip-sub{font-size:12px;color:#64748b;margin-top:2px;line-height:1.4}.model-strip-tags{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end}.model-running{border:1px solid #d7d7ff;background:#f7f8ff;color:#3525cd;border-radius:12px;padding:11px 13px;margin:0 0 14px;font-size:13px;font-weight:850;display:flex;gap:10px;align-items:center}@media(max-width:1000px){.model-strip{align-items:flex-start;flex-direction:column}.model-strip-tags{justify-content:flex-start}}
.breakdown-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:18px;margin-top:18px}.bd-card{border:1px solid var(--line);border-radius:16px;background:#fff;padding:18px;min-width:0}.bd-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:14px}.bd-title{font-weight:900;color:#0b1c30;font-size:15px;line-height:1.45}.bd-target{font-size:12px;color:#64748b;margin-top:3px}.bd-stack{display:flex;flex-direction:column;gap:14px}.bd-row{display:grid;grid-template-columns:minmax(118px,150px) minmax(0,1fr);column-gap:14px;row-gap:6px;align-items:center}.bd-lab{font-weight:850;color:#0b1c30;font-size:13px;line-height:1.35}.bd-val{font-size:12px;color:#64748b;margin-top:2px}.bd-track{height:10px;background:#eef2f7;border-radius:999px;overflow:hidden}.bd-fill{height:100%;border-radius:999px;background:var(--t)}.bd-fill.neg{background:#ef5f73}.bd-meta{grid-column:2;display:flex;justify-content:flex-start;align-items:center;gap:8px;margin-top:-2px}.bd-chip{display:inline-flex;border-radius:999px;padding:4px 10px;font-size:12px;font-weight:850;border:1px solid #a9eee4;background:var(--ts);color:#04786e}.bd-chip.neg{border-color:#fecdd3;background:var(--ds);color:#b91c1c}.bd-score{font-size:12px;color:#64748b;font-weight:750}.bd-note{font-size:12px;color:#64748b;line-height:1.55;margin-top:14px}.tech-shap{margin-top:18px;border:1px solid #dbe4fb;border-radius:14px;background:#fbfdff;overflow:hidden}.tech-shap summary{cursor:pointer;list-style:none;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:14px 16px;font-weight:900;color:#0b1c30}.tech-shap summary::-webkit-details-marker{display:none}.tech-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;padding:0 16px 16px}.tech-card{border:1px solid var(--line);border-radius:12px;background:#fff;padding:14px;min-width:0}.tech-title{font-size:13px;font-weight:900;color:#334155;margin-bottom:10px}.tech-row{display:grid;grid-template-columns:minmax(112px,1fr) 84px 58px;gap:10px;align-items:center;padding:8px 0;border-top:1px solid #edf1f7}.tech-row:first-of-type{border-top:0}.tech-label{font-size:12px;font-weight:850;color:#0b1c30;line-height:1.35}.tech-value{font-size:11px;color:#64748b;margin-top:2px}.tech-score{font-size:12px;font-weight:850;color:#64748b;text-align:right}.tech-score.neg{color:#b91c1c}
...
div[data-testid="stForm"]{background:#fff!important;border:1px solid var(--line)!important;border-radius:16px!important;padding:22px 16px 14px!important;box-shadow:0 4px 12px rgba(15,23,42,.04)!important}.tile.dose .v{font-size:26px}.tile .dose-code{display:inline-flex;margin-right:6px;border-radius:999px;padding:2px 8px;background:#fff;border:1px solid #d7d7ff;color:var(--pd);font-family:"JetBrains Mono",monospace;font-size:11px;font-weight:850}
...
.breakdown-grid.gn-explain-grid,.breakdown-grid.outcome-explain-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.breakdown-row-title{font-size:13px;font-weight:900;color:#475569;margin:18px 0 -2px}.ohss-grid{display:grid;grid-template-columns:1.1fr .95fr;gap:18px;align-items:stretch}.ohss-card{border:1px solid var(--line);border-radius:16px;background:#fff;padding:20px;min-width:0}.ohss-card.primary{background:#f8fbff;border-color:#cfdcf6}.ohss-title{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:16px}.ohss-title h3{margin:0;font-size:20px;color:#0b1c30}.ohss-title .en{font-size:12px;color:#64748b;margin-top:4px;font-weight:750}.ohss-main{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.ohss-k{font-size:12px;color:#64748b;font-weight:800}.ohss-v{font-size:28px;font-weight:950;color:var(--pd);margin-top:5px}.ohss-sub{font-size:12px;color:#475569;line-height:1.55;margin-top:14px}.ohss-factor-grid{display:grid;grid-template-columns:1fr 1fr;gap:18px}.ohss-factor-head{font-size:14px;font-weight:900;color:#0b1c30;margin-bottom:12px}.risk-row{display:grid;grid-template-columns:minmax(128px,166px) 1fr;gap:12px;align-items:center;margin:12px 0}.risk-name{font-size:13px;font-weight:850;color:#0b1c30;line-height:1.35}.risk-val{font-size:12px;color:#64748b;margin-top:2px}.risk-track{height:10px;border-radius:999px;background:#eef2f7;overflow:hidden}.risk-fill{height:100%;border-radius:999px;background:var(--d)}.risk-fill.down{background:var(--t)}.risk-meta{grid-column:2;display:flex;gap:8px;align-items:center;margin-top:-4px}.risk-note{font-size:12px;color:#64748b;line-height:1.55;margin-top:12px}.safety-concern{display:inline-flex;border-radius:999px;padding:4px 10px;font-size:12px;font-weight:850;border:1px solid #fed7aa;background:#fff7ed;color:#b45309}.safety-concern.high{border-color:#fecdd3;background:#fff1f2;color:#b91c1c}@media(max-width:1000px){.ohss-grid,.ohss-main,.ohss-factor-grid{grid-template-columns:1fr}}
.bd-prob-flow{display:flex;align-items:center;justify-content:flex-end;gap:8px;flex:0 0 auto}.bd-base{display:flex;align-items:baseline;gap:6px;color:#64748b;font-size:11px;font-weight:750;white-space:nowrap}.bd-base strong{color:#334155;font-size:13px;font-weight:900}.bd-arrow{color:#6366f1;font-size:18px;font-weight:900;line-height:1}.bd-row.other{padding-top:12px;border-top:1px solid #e5eaf2}.bd-row.other .bd-lab{color:#334155}.bd-row.other .bd-val{font-size:11px}.bd-other-details{margin-top:2px;border-top:1px solid #dfe6ef}.bd-other-details summary{cursor:pointer;list-style:none;padding-top:13px;border-top:0}.bd-other-details summary::-webkit-details-marker{display:none}.bd-other-toggle{display:inline-flex;align-items:center;border:1px solid #cbd5e1;border-radius:6px;padding:3px 7px;background:#fff;color:#475569;font-size:11px;font-weight:850}.bd-other-toggle .opened{display:none}.bd-other-details[open] .bd-other-toggle .closed{display:none}.bd-other-details[open] .bd-other-toggle .opened{display:inline}.bd-other-list{margin-top:10px;padding:8px 10px;border:1px solid #e3eaf2;border-radius:8px;background:#f8fafc;max-height:250px;overflow:auto}.bd-other-item{display:grid;grid-template-columns:minmax(0,1fr) auto minmax(76px,auto);gap:10px;align-items:center;padding:8px 2px;border-top:1px solid #e8edf3}.bd-other-item:first-child{border-top:0}.bd-other-name{font-size:12px;font-weight:850;color:#27364a}.bd-other-value{font-size:11px;color:#64748b;margin-top:2px}.bd-other-item strong{font-size:11px;color:#475569;text-align:right;white-space:nowrap}.bd-mini-chip{display:inline-flex;border-radius:999px;padding:3px 7px;font-size:10px;font-weight:850;border:1px solid #a9eee4;background:#ecfdf9;color:#04786e;white-space:nowrap}.bd-mini-chip.down{border-color:#fecdd3;background:#fff1f2;color:#b91c1c}.bd-other-empty{padding:10px;color:#64748b;font-size:12px;text-align:center}@media(max-width:680px){.bd-head{align-items:flex-start}.bd-prob-flow{align-items:flex-end;flex-direction:column;gap:4px}.bd-arrow{display:none}.bd-other-item{grid-template-columns:minmax(0,1fr) auto}.bd-other-item strong{grid-column:2}.bd-other-toggle{padding:3px 6px}}
.breakdown-grid.gn-explain-grid,.breakdown-grid.outcome-explain-grid{gap:16px;align-items:stretch}.bd-card{display:flex;flex-direction:column;height:100%;padding:17px;border-radius:14px;background:#fff}.bd-card.probability-card{border-color:#d8dcfa}.bd-card.outcome-card{border-color:#cfe8e5;background:#fcfefe}.bd-head{min-height:54px;margin-bottom:16px;padding-bottom:13px;border-bottom:1px solid #edf1f7}.bd-title{font-size:15px;line-height:1.35}.bd-target{margin-top:4px;line-height:1.4}.bd-stack{flex:1;gap:13px}.bd-row{grid-template-columns:minmax(112px,142px) minmax(0,1fr);column-gap:13px;row-gap:5px;margin:0}.bd-track{height:8px}.bd-meta{gap:7px}.bd-score{font-weight:850;color:#475569}.bd-row.other{margin-top:2px;padding-top:13px;border-top:1px solid #dfe6ef}.bd-fill.neutral{background:#94a3b8}.bd-chip.neutral{border-color:#cbd5e1;background:#f8fafc;color:#64748b}.breakdown-row-title{display:flex;align-items:center;min-height:28px;margin:22px 0 11px;padding-left:10px;border-left:3px solid var(--p);font-size:14px;font-weight:900;color:#27364a}.breakdown-row-title.outcome-title{border-left-color:var(--t)}@media(max-width:1000px){.breakdown-grid.gn-explain-grid,.breakdown-grid.outcome-explain-grid{grid-template-columns:1fr}.bd-card{height:auto}}@media(max-width:520px){.bd-row{grid-template-columns:minmax(100px,128px) minmax(0,1fr)}.bd-card{padding:15px}}
...
.response-line{display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin-top:6px}.response-line .v{margin-top:0}.response-strategy{display:flex;align-items:center;justify-content:space-between;gap:14px;border:1px solid #cfe8e5;background:#f7fffd;border-radius:12px;padding:11px 14px;margin:0 0 16px}.response-strategy-main{display:flex;align-items:center;gap:9px;flex-wrap:wrap;font-size:13px;color:#334155}.response-strategy-main b{color:#0b1c30}.response-strategy-rule{font-size:12px;color:#64748b;font-weight:750}.response-low{background:#eef0ff;border-color:#d7d7ff;color:#3525cd}.response-normal{background:#dcfbf6;border-color:#a9eee4;color:#04786e}.response-high{background:#fff7ed;border-color:#fed7aa;color:#b45309}
...
.knn-evidence-head{display:flex;align-items:center;gap:10px;margin:26px 0 14px}.knn-evidence-head .ic{width:28px;height:28px;border-radius:8px;background:var(--ps);color:var(--pd);display:grid;place-items:center;font-weight:900}.knn-evidence-head h3{margin:0;font-size:20px}.knn-drug-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px}.knn-drug-card{border:1px solid var(--line);border-radius:12px;background:#fff;overflow:hidden;min-width:0}.knn-drug-title{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:14px 15px;border-bottom:1px solid #e5eaf2;color:#0b1c30;font-size:15px;font-weight:900}.knn-mini-table{width:100%;border-collapse:collapse;table-layout:fixed}.knn-mini-table th{background:#eef3ff;color:#475569;font-size:11px;font-weight:850;padding:10px 7px;text-align:center;border:0}.knn-mini-table td{font-size:12px;font-weight:750;padding:11px 7px;text-align:center;border-top:1px solid #edf1f7;white-space:nowrap}.knn-mini-table td:first-child{font-weight:900;color:var(--pd)}.knn-evidence-note{font-size:12px;color:#64748b;line-height:1.55;margin-top:10px}@media(max-width:1000px){.knn-drug-grid{grid-template-columns:1fr}}
.curve-rec-summary{display:grid;grid-template-columns:1.15fr .8fr .9fr;gap:8px;margin:13px 0 2px;padding:8px 10px;border:1px solid #dbe4fb;border-radius:8px;background:#f8fbff;color:#64748b;font-size:11px;font-weight:750}.curve-rec-summary span{min-width:0;white-space:nowrap}.curve-rec-summary b{color:#27364a;font-weight:900}.curve-rec-summary .dose{color:#3525cd;font-weight:900}
...
def header():
    ...
    st.markdown(f'<div class="topbar"><div class="brand"><div class="mark">⚕</div><div><div class="brand-name">Gn 剂量辅助系统</div><div class="sub">医生端临床辅助决策界面</div></div></div><div class="actions"><div class="nav-i notice" aria-label="通知">{BELL_ICON}</div><div class="nav-i" aria-label="设置">{SETTINGS_ICON}</div><div class="avatar" aria-label="医生账户">医</div></div></div>', unsafe_allow_html=True)
...
def patient_page():
    ...
    with st.form("patient_form"):
        ...
        field_label(c[3],"AFC（个）",True); v["afc"]=c[3].number_input("AFC（个）",0,60,int(v["afc"]),label_visibility="collapsed",key="afc")
        c=st.columns(5)
        field_label(c[0],"基础 FSH（IU/L）",True); v["basal_fsh"]=c[0].number_input("基础 FSH（IU/L）",0.0,40.0,float(v["basal_fsh"]),step=.1,label_visibility="collapsed",key="basal_fsh")
        field_label(c[1],"基础 LH（IU/L）",True); v["basal_lh"]=c[1].number_input("基础 LH（IU/L）",0.0,40.0,float(v["basal_lh"]),step=.1,label_visibility="collapsed",key="basal_lh")
        field_label(c[2],"基础 E2（pg/mL）",True); v["basal_e2"]=c[2].number_input("基础 E2（pg/mL）",0.0,500.0,float(v["basal_e2"]),label_visibility="collapsed",key="basal_e2")
        field_label(c[3],"基础 P（ng/mL）",True); v["basal_p"]=c[3].number_input("基础 P（ng/mL）",0.0,10.0,float(v["basal_p"]),step=.1,label_visibility="collapsed",key="basal_p")
        field_label(c[4],"不孕年限（年）",False); v["years"]=c[4].number_input("不孕年限（年）",0,20,int(v["years"]),label_visibility="collapsed",key="years")
        c=st.columns(2)
...
def ohss_warning_card(row):
    ...
    st.markdown(f'''<div class="sec"><div class="ohss-card primary"><div class="ohss-title"><div><h3>\u4e2d\u91cd\u5ea6 OHSS \u65e9\u671f\u9884\u8b66</h3><div class="en">Moderate-to-severe OHSS early warning</div></div>{ohss_badge(row)}</div><div class="ohss-main"><div><div class="ohss-k">\u9884\u6d4b\u4e2d\u91cd\u5ea6 OHSS \u98ce\u9669</div><div class="ohss-v">{ohss_display_pct(row)}</div></div><div><div class="ohss-k">\u98ce\u9669\u5206\u7ea7</div><div class="ohss-v">{prof["category_zh"]}</div></div><div><div class="ohss-k">\u53c2\u8003\u4eba\u7fa4\u4f4d\u7f6e</div><div class="ohss-v" style="font-size:22px">{escape(percentile)}</div></div></div><div class="ohss-sub">\u57fa\u4e8e\u5f53\u524d\u4fc3\u6392\u76d1\u6d4b\u4fe1\u606f\u53ca\u5386\u53f2\u7528\u836f\u8f68\u8ff9\u3002{OHSS_UI_DISCLAIMER}</div></div></div>''',unsafe_allow_html=True)
...
def summary(b):
    fl=b["fsh_category"][0]
    st.markdown(
        f"""<div class="card pad"><div class="head"><div class="ic">✦</div><h3>模型推荐总览</h3><span class="chip cp">获卵数 / OHSS 平衡参考</span></div><div class="sg" style="grid-template-columns:repeat(5,minmax(0,1fr))"><div class="tile dose"><div class="k">模型推荐 FSH</div><div class="v">{escape(fl)}</div></div><div class="tile dose"><div class="k">模型推荐 LH</div><div class="v">{fmt(b["lh"])} <span style="font-size:13px">IU/天</span></div></div><div class="tile dose"><div class="k">模型推荐 HMG</div><div class="v">{fmt(b["hmg"])} <span style="font-size:13px">IU/天</span></div></div><div class="tile"><div class="k">预测获卵数</div><div class="v">{fmt(b["o"])}</div></div><div class="tile"><div class="k">中重度 OHSS 风险</div><div class="v">{ohss_display_pct(b)}</div>{ohss_badge(b)}</div></div></div>""",
