...
.nav-brand .mark{width:30px;height:30px;border-radius:8px;background:#EFF4FF;color:#3B82F6;display:grid;place-items:center;font-weight:700;font-size:16px;flex:0 0 auto}
.nav-brand .brand-name{font-size:18px;font-weight:600;color:#1D2939;white-space:nowrap}
.nav-brand .sub{font-size:12px;color:#98A2B3;white-space:nowrap;margin-top:2px}
...
.title h1{font-size:24px!important;font-weight:600!important;color:#1D2939!important;margin:0 0 6px!important;line-height:1.4}
...
.head .ic{width:24px!important;height:24px!important;border-radius:6px!important;background:#EFF4FF!important;color:#3B82F6!important;font-size:13px!important}
.head h3{font-size:18px!important;font-weight:600!important;color:#344054!important}
...
/* “第 N 次监测记录”标题 */
.monitor-record-title{font-size:14px!important;font-weight:600!important;color:#344054!important;margin:0 0 12px!important}

/* 二级分组标题 15px/500/#475467 + 极浅 #F2F4F7 细分隔线 */
.monitor-section-title{font-size:15px!important;font-weight:500!important;color:#475467!important;margin:14px 0 10px!important;padding:12px 0 0!important;border-top:1px solid #F2F4F7!important;border-left:0!important;background:transparent!important;border-radius:0!important}

/* 表单 label 13px/400/#475467；固定两行高保证同排输入框对齐 */
.field-label{font-size:13px!important;font-weight:400!important;color:#475467!important;margin:0 0 6px!important;min-height:40px;line-height:1.4}
...
.stApp [data-baseweb="select"]>div>div{
  font-size:14px!important;font-weight:400!important;color:#1D2939!important;
  -webkit-text-fill-color:#1D2939!important
}
.stApp [data-baseweb="select"]{color:#1D2939!important;font-size:14px!important}
...
/* 辅助提示 12px/#F97316 */
.mini-hint{font-size:12px!important;color:#F97316!important;background:#FFF7ED!important;border:1px solid #FED7AA!important;border-radius:6px!important;font-weight:400!important;padding:8px 10px!important;line-height:1.5}
</style>
"""
